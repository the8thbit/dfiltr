...
options.createLogoutEvent = function(){
...
options.createChangePassEvent = function(){
...
options.createChangeEmailEvent = function(){
...
options.createEvents = function(){
	options.createLogoutEvent();
	options.createChangePassEvent();
	options.createChangeEmailEvent();
	options.createHoverFadeEvent();
}
