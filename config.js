...
//SECRET FOR SESSION DATA                     //
  var COOKIE_SECRET =                         //
  process.env.COOKIE_SECRET                   // toggle on for local testing
...
//PREDICTIONIO CONNECTION INFO                //
  var PIO_API_KEY =                           //
  process.env.PIO_API_KEY                     // toggle on for local testing
//process.env.OPENSHIFT_PIO_API_KEY           // toggle on for openshift deploy
//============================================//
  var PIO_API_IP =                            //
  process.env.PIO_API_IP                      // toggle on for local testing
//process.env.OPENSHIFT_PIO_API_IP            // toggle on for openshift deploy
//============================================//
  var PIO_API_PORT =                          //
  process.env.PIO_API_PORT                    // toggle on for local testing
